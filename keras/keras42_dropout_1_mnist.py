...
model.add(Dropout(0.2))                                                                                 # Dropout 0.2 => 80%의 노드만 연산에 사용하겠다.
...
model.fit(x_train, y_train, epochs = 100, batch_size = 100, validation_split = 0.2, verbose = 1, callbacks = [early_stopping, to_list])
...
# accuracy 
# 480/480 [==============================] - 3s 5ms/step - loss: 0.0165 - accuracy: 0.9946 - val_loss: 0.0752 - val_accuracy: 0.9866
# 100/100 [==============================] - 0s 2ms/step - loss: 0.0725 - accuracy: 0.9849
# loss :  0.07250496745109558
