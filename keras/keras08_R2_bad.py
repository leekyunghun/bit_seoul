...
model.add(Dense(1000, input_dim = 1))    # input_dim = 1 => input이 1차원              #model.add(Dense(32, input_dim = 1))   값이 잘 나옴
model.add(Dense(1000))                                                                #model.add(Dense(16))
model.add(Dense(2000))                                                                 #model.add(Dense(8))
