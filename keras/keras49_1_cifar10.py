...
# 3. 컴파일, 훈련
modelpath = "./model/cifar10/{epoch:02d}-{val_loss: 4f}-third.hdf5"                               # Checkpoint가 저장될 경로 설정
...
model.save("./save/cifar10/cifar10_model_2.h5")
model.save_weights("./save/cifar10/cifar10_weights.h5")
